...
procedure Main is
   ...
   Steps_Array : Task_Step := (1, 2, 3 ,4);
   Sequence_Array : Task_Sequence := (1, 2, 3, 4);
   Initial_Value_Array : Task_Initial_Value := (0, 0, 0, 0);
   ...
   begin
      ...
      Put_Line("Thread " & Sequence_Number'Img & " - Final Sum: " & Initial_Value'Img & " - Total elements: " & Number_Sequence_Elements'Img);
   end main_thread;
